...
<html>
    ...
    <body>
        ...
        <div id="headmenu" class="container">
            <h1 id="Hport"> Martin Skowron 
                <a class="icon_title" target="_blank" href="https://www.linkedin.com/in/skowron-martin-34748914b/"><i class="fab fa-linkedin"></i></a>
                <a class="icon_title" target="_blank" href="https://www.facebook.com/martin.skowron.142/"><i class="fab fa-facebook-square"></i></a>
                <a class="icon_title" target="_blank" href="https://github.com/Aethernum"><i class="fab fa-github-square"></i></a>
                <a class="icon_title" target="_blank" href="mailto:martinsko@sfr.fr"><i class="fas fa-envelope"></i></a>
            </h1>
            ...
            <ul>
                ...
                <li><a href="/Ressource/Martin_Skowron_CV.pdf" target="_blank" class="ic">CV<i class="fas fa-file-download" style="padding-left:10px"></i></a></li>
            </ul>
            </div>
        </div>
        </header>
